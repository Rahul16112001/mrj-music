...
app.post(['/api/user/preferences', '/user/preferences', '/api/user/onboarding', '/user/onboarding'], requireAuth, async (req, res) => {
  try {
...
app.get(['/api/user/preferences', '/user/preferences', '/api/user/taste-profile', '/user/taste-profile'], requireAuth, async (req, res) => {
  try {
